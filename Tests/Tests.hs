...
test_addfiles = TestCase (assertEqual "adding files" ([(Folder "2" "root child" (Just "1") [] []),(Folder "1" "root" Nothing [] [File "101" "file1" "www.file.com" "1"])]) (addFiles [(Folder "1" "root" Nothing [] []),(Folder "2" "root child" (Just "1") [] [])] [(File "101" "file1" "www.file.com" "1")]))
